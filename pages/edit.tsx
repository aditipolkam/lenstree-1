      ...
      <div className="header-container">
        <header>
          <div className="left">
            ...
            <p className="subtitle">Verify your digital identities.</p>
          </div>
          <div className="right">
